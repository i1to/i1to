...
export CVSROOT=:pserver:liyue@ddcvs.dasannetworks.com:/home/ddcvs/ddSource
#export CSCOPE_DB=/home/humy/code/v1916gr/dbase/cscope.out
...
#export PS1='\[\e[01;30m\][\u@\[\e[01;35m\]\h \[\e[01;30m\]\w] `[[ -d .git ]] && echo -n -e "\[\e[01;30m\](branch:$(git branch | sed -e "/^ /d" -e "s/* \(.*\)/\1/"))\[\e[01;04m\] "`\$ \[\e[01;30m\]'
...
export LARCH_PATH=/usr/local/bin/share/splint/lib
export LCLIMPORTDIR=/usr/local/bin/share/splint/imports
export PATH=$PATH:/home/liyue/bin
export PAGER=more
